 ...
 const jobOpenings = [
  ...
  return (
    <div className='parent'>
      ...
      return <Card company={elem.companyName} post={elem.post} date={elem.datePosted} pay={elem.pay} location={elem.location} logo={elem.brandLogo} tag1={elem.tag1} tag2={elem.tag2} />
    })}
    </div>
  )
}
